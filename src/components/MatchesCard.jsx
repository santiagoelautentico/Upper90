const MatchesCard = ({ match, backgroundColor }) => {
  console.log(match.status, "match status in card");
    ...
    <div className={`matchesCard-container ${backgroundColor}`}>
      {match.leagueName === "La Liga" ? (
        ...
        <img
          src="/premierIcon.svg"
          alt="Premier League"
          className="league-icon league-premier-icon-match"
        />
      ) : (
        <img src="/serieAIcon.svg" alt="Serie A" className="league-icon" />
      )}
      <div className="status-container">
        {match.status === "Scheduled" ? (
          <>
            <span className="match-time">{formatDate(match.matchDate)}</span>
      ...
      <div className="team-name-container home-team-name-container">
        <h3>{match.homeTeamName}</h3>
        <img
          src={match.homeTeamLogo}
          alt={match.homeTeamLogo}
          className="logo-matchCard"
        />
      </div>
